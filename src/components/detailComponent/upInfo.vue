    ...
    <div class="up-info">
        <div class="u-face">
            <img style="width: 48px;height: 48px;" @click="$util.goUser(detailList.up)"
                :src="$util.url.load + detailList.avatar">
        </div>
        <div class="up-info-right">
            <div class="name">
                <span @click="$util.goUser(detailList.up)">{{ detailList.nickname }}</span>
            ...
            <div class="btn-panel">
                <button class="charge change-color">
                    <img :src="$util.url.load + 'https://i0.hdslb.com/bfs/garb/item/33e2e72d9a0c855f036b4cb55448f44af67a0635.png@.png'"
                        alt="">
                    <span>为TA充电</span>
                </button>
