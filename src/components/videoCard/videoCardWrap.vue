            ...
            <div class="video-card__image">
                <div class="video-card__image--wrap">
                    <picture class="video-card__cover">
                        <img style="width: 100%;height: 100%;" :src="$util.url.load + img" :alt="title" loading="eager">
                    </picture>
                </div>
                <div class="video-card__mask">
                    <div class="video-card__mask__stats">
                        <div class="video-card__mask__stats--left">
                            <span class="icon-horizontal" style="margin-right: 12px;">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 24 24" width="18" height="18" fill="#ffffff"
                        ...
                        <div class="video-card__mask__stats--right">5:20</div>
                    </div>
                </div>
            </div>
        </a>
        <div class="video-card__info">
            <div class="video-card__info--tit" :title="title">
                <a class="hover-blue change-color" :href="baseUrl + id" target="_blank">{{ title }}</a>
            </div>
            <div class="video-card__info--bottom">
                <a class="icon-horizontal hover-blue change-color" :href="upUrl + id" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"
                        width="17" height="17" fill="currentColor" class="bili-video-card__info--owner__up"><!--[-->
                        <path
