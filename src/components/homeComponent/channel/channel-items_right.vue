<template>
    <div class="right-channel_right">
        <span class="channel-link_right" v-for="item in channelRightList" :key="item.id">
            <a class=" icon-horizontal hover-blue change-color" :href="baseUrl + item.id" target="_blank">
                <p v-html="item.svg"></p>
                <span>{{ item.name }}</span>
            </a>
        </span>
